...
<script>localStorage.removeItem('commentdraft<?php the_ID(); ?>');</script>
<div id="comment-<?php comment_ID(); ?>" class="singlecomment">
	<div class="comment-author">
		<?php echo get_avatar( $comment->comment_author_email, 40 ); ?>
		<?php printf(__('<cite class="fn">%s</cite> <span class="says">says on </span>'), get_comment_author_link()) ?><?php printf(__('%1$s at %2$s'),get_comment_date('m/d'),get_comment_time('H:i:s'))?>:
	</div>
